...
const options = ["JavaScript", "PHP", "ReactJs", "Python", "Css", "Angular"];
...
const AddEditBlog = () => {
  ...
  const onUploadImage = (file) => {
    ...
    formData.append("upload_preset", "xj7mwffa");
    axios
      .post("http://api.cloudinary.com/v1_1/dajehl526/image/upload", formData)
      .then((resp) => {
